export function selectGestationalAgeCriteria() {
    ...
    const selectCriteria = document.querySelector(".calculator__select--criteria");
    const currentDateField = document.querySelector(".calculator__fieldset--current-date");
    const lmpField = document.querySelector(".calculator__fieldset--lmp");
    const ultrasoundField = document.querySelector(".calculator__fieldset--ultrasound");
...
//# sourceMappingURL=selectGestationalAgeCriteria.js.map